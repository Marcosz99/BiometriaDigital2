 ...
 * @author Admin
 */
public class TelaVisualizarDadosPaciente extends javax.swing.JFrame {

    /**
     * Creates new form TelaVisualizarDadosPaciente
     */
    public TelaVisualizarDadosPaciente() {
        initComponents();
    }
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(44, 44, 44))
                                    .addComponent(txfUsuario, javax.swing.GroupLayout.DEFAULT_SIZE, 140, Short.MAX_VALUE))
                                .addGap(26, 26, 26))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(40, 40, 40)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVisualizarDadosPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaVisualizarDadosPaciente().setVisible(true);
            }
        });
    }
